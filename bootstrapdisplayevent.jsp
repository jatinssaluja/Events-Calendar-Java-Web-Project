...
var http;
  ...
  var v2 = document.frm1.D1.options[v1].text;
     ...
     http.open('POST','usersort.jsp?e1='+v2,true);
...
ht.setAttribute("mytype",x1);
ht.setAttribute("mysubtype",x2);
ht.setAttribute("mystate",x3);
ht.setAttribute("mycity",x4);
...
ResultSet rs1=st1.executeQuery("select * from event where type ='"+x1+"' and subtype ='"+x2+"' and state ='"+x3+"' and city ='"+x4+"' order by start desc ");

if(rs1.isBeforeFirst()!=true){

response.sendRedirect("noevent.jsp");

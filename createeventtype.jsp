...
var http;
  ...
  var v2 = document.frm1.D1.options[v1].text;
     ...
     http.open('POST','vieweventsubtype.jsp?e1='+v2,true);
...
<div class="container">
 ...
 <p><div id="i2"><label>View SubType:</label>
...
<button class="btn btn-lg btn-primary btn-block" type="submit" id="show">CREATE NEW TYPE</button>


<br/>


<form action="addeventtype.jsp">
<div id="htext" hidden>

Enter Event Type: <input type="text" name="type" required size="20"/>

<br/>
<br/>

Enter Event Sub Type: <input type="text" name="subtype" required size="20"/>
...
<form action="viewfordelete.jsp">

<button class="btn btn-lg btn-primary btn-block" type="submit" id="delete">DELETE EVENT TYPE</button>

...
String x1 = (String)ht.getAttribute("mytype");

String x2 = (String)ht.getAttribute("mysubtype");

String x3 = (String)ht.getAttribute("mystate");

String x4 = (String)ht.getAttribute("mycity");
...
rs1 = st1.executeQuery("select * from event where type ='"+x1+"' and subtype ='"+x2+"' and state ='"+x3+"' and city ='"+x4+"' order by name ");


}

if(x5.equals("Start Date"))
{

rs1 = st1.executeQuery("select * from event where type ='"+x1+"' and subtype ='"+x2+"' and state ='"+x3+"' and city ='"+x4+"' order by start desc ");

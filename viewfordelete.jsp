...
ResultSet rs1=st1.executeQuery("select * from categ ");
...
%>
      ...
      <a href="deleteeventtype.jsp?e1=<%= x%>&e2=<%= s1%>" class="btn btn-info" role="button">DELETE</a>
...
<form action="createeventtype.jsp">
